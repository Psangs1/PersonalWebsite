...
function ProjectShowcase() {
    ...
    return (
      <>
        <section id='project-showcase' className='min-h-screen rounded-4xl w-full bg-card p-10'>
        <div className='font-bold text-[64px] font-primary'>
            <h1>Project Showcase</h1>
        </div>
        <div className='flex flex-row'>
            <button className='hover:bg-blue-100 text-5xl px-4 transition duration-150 ease-in-out' 
          ...
          <div className='p-8 rounded-2xl font-primary w-full max-w-[1000px] h-[550px] mx-auto overflow-hidden'>
            ...
            <button className='hover:bg-blue-100 text-5xl px-4 transition duration-200 ease-in-out'
