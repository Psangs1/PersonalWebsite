...
const Footer = () => {
    return (    
        <>
        <footer className="rounded-lg mt-30 p-4">
            <div className="md:flex md:items-center md:justify-between align-bottom">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://parth-sangani.vercel.app" className="hover:underline">Parth Sangani™</a>
            </span>
